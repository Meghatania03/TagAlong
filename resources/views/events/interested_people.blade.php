...
@section('title', 'Interested People for ' . $event->title)
                    ...
                    @foreach($interestedUsers as $user)
                        <div class="bg-gray-50 rounded-xl p-6 shadow-sm hover:shadow-md transition duration-300">
                            ...
                            <div class="mt-4 flex space-x-2">
                                ...
                                <a href="{{ route('messages.index') }}?user={{ $user->id }}" class="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-lg transition duration-200">
                                    Message
                                </a>
                            </div>
                        </div>
